...
\subsection{The Synth and Its Modular Components}
	...
	\scalebox{1.3}{ \( \frac{2\pi}{sample_rate} * frequency \) }
...
float Oscillator::get_sample()
{
	...
	\scalebox{1.3}{ \( interrupts=\frac{phase}{1000ms} * interrupt frequency \) } \\[4pt]
	
	\scalebox{1.3}{ \( phase constant = \frac{|start gain - end gain|}{interrupts} \) } \\[4pt]
	...
	Interrupts: \scalebox{1.3}{ \( \frac{300}{1000}*1000=300 \) } \\[4pt]
	
	Attack constant: \scalebox{1.3}{ \( \frac{|0.0 - 1.0|}{300}=0.00333\)} \\[4pt]
